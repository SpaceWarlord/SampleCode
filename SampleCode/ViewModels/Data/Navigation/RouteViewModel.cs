...
public partial class RouteViewModel : DataViewModel, IViewModel<RouteViewModel>
{
    ...
    public RouteViewModel(RouteModel model)
    {
        Id = model.Id;
        Name = model.Name;
        //RouteAddresses = new ObservableCollection<RouteAddressViewModel>(RouteAddressViewModel.ToViewModels(model.RouteAddresses, null));
    ...
    public static RouteViewModel Create(RouteModel model)
    {
        ...
        routeVM.RouteAddresses = new ObservableCollection<RouteAddressViewModel>(RouteAddressViewModel.ToViewModels(model.RouteAddresses, routeVM));
        return routeVM;
    ...
    public static List<RouteViewModel> ToViewModels(List<RouteModel> models)
    {
        ...
        {
            list.Add(new RouteViewModel(model.Id, model.Name, RouteAddressViewModel.ToViewModels(model.RouteAddresses, null), model.Distance));
        }
        return list;
    }
}